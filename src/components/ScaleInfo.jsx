            ...
            <div className="info-card">
                <div className="info-header">
                    <h3 className="section-title">
                        <span className="section-title-ko">스케일 정보</span>
                        <span className="section-title-en">Scale Reference</span>
                    </h3>
                </div>
                <div className="info-content">
                            ...
                            <div className="info-value chords-value">
                                {primaryChords.length > 0 && (
                                    <div className="chord-section">
                                        <div className="chord-group-label">기본 코드 · Primary</div>
                                ...
                                {secondaryChords.length > 0 && (
                                    <div className="chord-section secondary">
                                        <div className="chord-group-label">대체 코드 · Secondary</div>
                                        <div className="chord-badges">
                    ...
                    <div className="info-item description">
                        <span className="info-label">설명 · Note</span>
